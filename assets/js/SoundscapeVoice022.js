class SoundscapeVoice002 {
  ...
  trigger( time ) {
    ...
    //Select a random buffer from loaded sounds.
    ...
    loopStart = offset,
    loopEnd = loopStart + ( this.beatDuration * .5 ) / Math.ceil( Math.random() * 2 ); //////
