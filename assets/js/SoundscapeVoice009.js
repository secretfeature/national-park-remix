class SoundscapeVoice009 {
  ...
  constructor( options ) {
    ...
    this.envelope = new ADSREnvelope( { 
      ...
      attack: this.beatDuration * .25,
      decay: this.beatDuration * .75,
      sustain: .75,
      release: this.beatDuration * .01
    } );
    ...
    this.filterEnvelope = new ADSREnvelope( { 
      audioContext: options.audioContext,
      attack:  this.beatDuration * .01,
      decay: this.beatDuration * 3, //3
      sustain: 22050,
      release: this.beatDuration * .01
    } );
