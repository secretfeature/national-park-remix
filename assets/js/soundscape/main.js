window.addEventListener( "load", function( event ) {
  ...
  if ( mobileAndTabletcheck() )
    alert("This effect does not work on mobile, yet :(")
  ...
  function startClickHandler( event ) {
    ...
    $buttonElement.off('click touchend', startClickHandler);
      ...
      $buttonElement
        .on( 'click touchend', function( event ) {
          ...
          if( bufferId != undefined )
            bufferPlayer.stop( bufferId );
          //buffer, time = this.audioContext.currentTime, offset = 0, duration, loop = false, loopStartTime = 0, loopEndTime
          bufferId = bufferPlayer.start( item1.buffer, audioContext.currentTime, 0, 60, true, 0, beatDuration * 4 );
